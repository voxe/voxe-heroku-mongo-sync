module Heroku::Command
  class Mongo < BaseWithApp
    ...
    def push
      display "THIS WILL REPLACE ALL DATA FROM #{local_mongo_uri} TO #{heroku_mongo_uri}"
    ...
    def pull
      display "Replacing the local voxe-db at #{local_mongo_uri} with #{heroku_mongo_uri}"
